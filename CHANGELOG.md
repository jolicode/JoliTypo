...
* Add `SmartSingleQuotes` fixer converting pairs of single quotes to the nested quotation marks of the locale (‘…’, ‚…‘, “…”...), and add it to the recommended rules before `CurlyQuote` (#69, #75)
